    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('watermark', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='photo_sizes', to='photologue.Watermark', verbose_name='watermark image')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('effect', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='photo_related', to='photologue.PhotoEffect', verbose_name='effect')),
            ],
            options={
                'verbose_name': 'photo',
